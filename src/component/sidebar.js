    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          <li
            className={
              this.isPathActive("/withdraw") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/referral") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/tiket") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/candle") ? "nav-item active" : "nav-item"
            }
          >
